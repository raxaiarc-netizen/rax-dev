...
export class PreviewsStore {
  ...
  #REFRESH_DELAY = 500; // Increased from 150ms to reduce overhead and improve performance
  ...
  async #init() {
    ...
    webcontainer.on('port', (port, type, url) => {
      ...
      if (type === 'close' && previewInfo) {
        console.log('[Preview] Closing port:', port);
      ...
      if (!previewInfo) {
        console.log('[Preview] New preview registered:', { port, url });
      ...
      console.log('[Preview] Updated previews:', this.previews.get());
