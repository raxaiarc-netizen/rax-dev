...
<artifact_info>
  ...
  - Use \`<raxArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<raxAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<raxArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<raxAction>\` tags with appropriate \`type\` attribute:
