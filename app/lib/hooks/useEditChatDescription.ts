 ...
 * - Save updates to cloud storage and optionally to the global application state.
 *
  ...
  const handleSubmit = useCallback(
    async (event: React.FormEvent) => {
      ...
      try {
        ...
        // Update chat description via cloud API (description is the title parameter)
        await ChatAPI.updateChat(chatId, undefined, currentDescription);
