      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-rax-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-rax-elements-item-backgroundAccent hover:bg-rax-elements-artifacts-backgroundHover"
