      ...
      try {
        ...
        reader.onload = (e) => {
          ...
          if (textarea) {
            ...
            const setUploadedFiles = (window as any).__RAX_SET_UPLOADED_FILES__;
            const setImageDataList = (window as any).__RAX_SET_IMAGE_DATA_LIST__;
            const uploadedFiles = (window as any).__RAX_UPLOADED_FILES__ || [];
            const imageDataList = (window as any).__RAX_IMAGE_DATA_LIST__ || [];
