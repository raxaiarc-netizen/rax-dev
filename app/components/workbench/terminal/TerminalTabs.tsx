  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-rax-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-rax-elements-background-depth-2 border-y border-rax-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-rax-elements-terminals-buttonBackground text-rax-elements-textSecondary hover:text-rax-elements-textPrimary':
                            isActive,
                          'bg-rax-elements-background-depth-2 text-rax-elements-textSecondary hover:bg-rax-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-rax-elements-terminals-buttonBackground text-rax-elements-textPrimary': isActive,
                            'bg-rax-elements-background-depth-2 text-rax-elements-textSecondary hover:bg-rax-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-rax-elements-textTertiary hover:text-rax-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachRaxTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting rax terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachRaxTerminal(terminal)}
