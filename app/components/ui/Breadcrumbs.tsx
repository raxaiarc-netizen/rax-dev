      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-rax-elements-textPrimary dark:text-rax-elements-textPrimary-dark'
              : 'text-rax-elements-textSecondary dark:text-rax-elements-textSecondary-dark hover:text-rax-elements-textPrimary dark:hover:text-rax-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-rax-elements-textTertiary dark:text-rax-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
