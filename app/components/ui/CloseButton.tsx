  ...
  return (
    <motion.button
      ...
      className={classNames(
        'text-rax-elements-textTertiary hover:text-rax-elements-textSecondary dark:text-rax-elements-textTertiary-dark dark:hover:text-rax-elements-textSecondary-dark',
        'rounded-lg hover:bg-rax-elements-background-depth-2 dark:hover:bg-rax-elements-background-depth-3',
