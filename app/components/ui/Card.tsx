  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-rax-elements-borderColor bg-rax-elements-background-depth-1 text-rax-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-rax-elements-textSecondary', className)} {...props} />;
  },
);
