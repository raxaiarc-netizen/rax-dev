        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-rax-elements-background-depth-2 dark:bg-rax-elements-background-depth-3 text-rax-elements-textPrimary dark:text-rax-elements-textPrimary-dark hover:bg-rax-elements-background-depth-3 dark:hover:bg-rax-elements-background-depth-4 border border-rax-elements-borderColor dark:border-rax-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
