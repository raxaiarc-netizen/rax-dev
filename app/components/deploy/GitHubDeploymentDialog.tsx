    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from Rax.ai' : 'Update from Rax.ai',
          tree: treeData.sha,
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-rax-elements-background-depth-3 flex items-center justify-center text-blue-500"
                  >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-rax-elements-background-depth-3 flex items-center justify-center text-blue-500"
                  >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-rax-elements-background-depth-2 dark:bg-rax-elements-background-depth-3 border border-rax-elements-borderColor dark:border-rax-elements-borderColor-dark text-rax-elements-textPrimary dark:text-rax-elements-textPrimary-dark placeholder-rax-elements-textTertiary dark:placeholder-rax-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required
                        maxLength={100}
                    ...
                    {repoName && sanitizeRepoName(repoName) !== repoName && (
                      <p className="text-xs text-rax-elements-textSecondary dark:text-rax-elements-textSecondary-dark mt-1">
                        Will be created as:{' '}
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-rax-elements-textPrimary dark:text-rax-elements-textPrimary-dark group-hover:text-blue-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                  ...
                  <div className="p-3 bg-rax-elements-background-depth-2 dark:bg-rax-elements-background-depth-3 rounded-lg border border-rax-elements-borderColor dark:border-rax-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="rounded border-rax-elements-borderColor dark:border-rax-elements-borderColor-dark text-blue-500 focus:ring-blue-500 dark:bg-rax-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
