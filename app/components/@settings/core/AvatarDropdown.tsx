        ...
        >
          ...
          <DropdownMenu.Item
            className={classNames(
              ...
              'hover:bg-purple-50 dark:hover:bg-blue-500/10',
          ...
          <DropdownMenu.Item
            ...
            onClick={() =>
              window.open('https://github.com/stackblitz-labs/rax.ai/issues/new?template=bug_report.yml', '_blank')
            }
          >
          ...
          <DropdownMenu.Item
            ...
            onClick={() => window.open('https://stackblitz-labs.github.io/rax.ai/', '_blank')}
          >
