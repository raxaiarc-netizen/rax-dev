        ...
        <div className="flex-1 space-y-3">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              ...
              {repo.private && (
                <div className="i-ph:lock w-3 h-3 text-rax-elements-textTertiary" title="Private repository" />
              )}
              {repo.fork && (
                <div className="i-ph:git-fork w-3 h-3 text-rax-elements-textTertiary" title="Forked repository" />
              )}
              {repo.archived && (
                <div className="i-ph:archive w-3 h-3 text-rax-elements-textTertiary" title="Archived repository" />
              )}
            </div>
          ...
          {repo.topics && repo.topics.length > 0 && (
            <div className="flex items-center gap-2 text-xs">
              ...
              {repo.topics.length > 3 && (
                <span className="text-rax-elements-textTertiary">+{repo.topics.length - 3} more</span>
              )}
            </div>
          )}
          ...
          {repo.size && (
            <div className="text-xs text-rax-elements-textTertiary">Size: {(repo.size / 1024).toFixed(1)} MB</div>
          )}
        </div>

        {/* Bottom section with Clone button positioned at bottom right */}
        <div className="flex items-center justify-between pt-3 mt-auto">
          <span className="flex items-center gap-1 text-xs text-rax-elements-textSecondary group-hover:text-rax-elements-item-contentAccent transition-colors">
