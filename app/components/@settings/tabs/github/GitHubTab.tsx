    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GithubLogo />
          <h2 className="text-lg font-medium text-rax-elements-textPrimary">GitHub Integration</h2>
        </div>
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            {connection?.rateLimit && (
              <div className="flex items-center gap-2 px-3 py-1 bg-rax-elements-background-depth-1 rounded-lg text-xs">
                <div className="i-ph:cloud w-4 h-4 text-rax-elements-textSecondary" />
        ...
        {stats?.repos && stats.repos.length > 0 && (
          <motion.div
            ...
            className="border-t border-rax-elements-borderColor pt-6"
          >
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-rax-elements-background dark:bg-rax-elements-background-depth-2 border border-rax-elements-borderColor dark:border-rax-elements-borderColor hover:border-rax-elements-borderColorActive/70 dark:hover:border-rax-elements-borderColorActive/70 transition-all duration-200">
                  ...
                  <ChevronDown
                    className={classNames(
                      'w-4 h-4 transform transition-transform duration-200 text-rax-elements-textSecondary',
                  ...
                  {stats.repos.length > 12 && !isReposExpanded && (
                    <div className="text-center">
                      <Button
                        ...
                        className="text-rax-elements-textSecondary hover:text-rax-elements-textPrimary"
                      >
        ...
        {isConnected && connection && (
          <div className="mt-8 pt-6 border-t border-rax-elements-borderColor">
