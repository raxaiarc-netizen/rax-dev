...
export default function NetlifyConnection() {
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  <BuildingLibraryIcon className="h-4 w-4 text-rax-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-rax-elements-textPrimary dark:text-rax-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-rax-elements-item-contentAccent" />
                ...
                {lastUpdated && (
                  <Badge
                    ...
                    className="flex items-center gap-1 text-rax-elements-textPrimary dark:text-rax-elements-textPrimary"
                  >
                    <ClockIcon className="h-4 w-4 text-rax-elements-item-contentAccent" />
                  ...
                  <div className="bg-rax-elements-background dark:bg-rax-elements-background-depth-1 border border-rax-elements-borderColor dark:border-rax-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-medium flex items-center gap-2 text-rax-elements-textPrimary dark:text-rax-elements-textPrimary">
                        <BuildingLibraryIcon className="h-4 w-4 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                      ...
                      >
                        <ArrowPathIcon
                          className={classNames(
                            'h-4 w-4 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-rax-elements-background dark:bg-rax-elements-background-depth-1 border rounded-lg p-4 transition-all',
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent" />
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            ...
                            >
                              <CloudIcon className="h-3 w-3 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent" />
                                ...
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-rax-elements-textPrimary dark:text-rax-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="h-4 w-4 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent" />
                                  ...
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <CodeBracketIcon className="h-4 w-4 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent" />
                                      <span className="text-rax-elements-textSecondary dark:text-rax-elements-textSecondary">
                          ...
                          >
                            ...
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-rax-elements-textSecondary dark:text-rax-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent" />
                                <span className="text-rax-elements-textSecondary dark:text-rax-elements-textSecondary">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-rax-elements-textPrimary dark:text-rax-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-rax-elements-textPrimary dark:text-rax-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-rax-elements-item-contentAccent dark:text-rax-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-rax-elements-textDestructive dark:text-rax-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-rax-elements-textDestructive dark:text-rax-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-rax-elements-background dark:bg-rax-elements-background border border-rax-elements-borderColor dark:border-rax-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-rax-elements-textPrimary">Netlify Connection</h2>
          </div>
        </div>
