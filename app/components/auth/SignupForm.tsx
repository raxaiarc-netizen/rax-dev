...
export function SignupForm({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="text-3xl font-semibold text-white/95 mb-6">Sign Up</span>
      ...
      >
        ...
        <div className="text-sm font-medium text-white/95">Sign up with GitHub</div>
      </button>
      ...
      >
        ...
        <div className="text-sm font-medium text-white/95">Sign up with Google</div>
      </button>

      {/* Divider */}
      <div className="w-full text-center text-white/60 text-sm my-6">Or Sign up with email</div>
      ...
      <div className="w-full flex-1 overflow-hidden">
        <form onSubmit={handleSubmit} className="w-full">
          ...
          <div className="text-white/60 text-sm mb-4 flex items-center justify-center">
            ...
            <Link to="/login" className="text-white/95 hover:text-white/60 transition-colors underline">
              Sign in
            </Link>
            &nbsp;now
          </div>
